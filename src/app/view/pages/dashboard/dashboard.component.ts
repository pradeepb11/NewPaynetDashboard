...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getPayoutReportmonth();
  }

  getPAyoutSuccessReport(){
    this.reportSerivce.payoutreportsucess()
    .subscribe(
      (res) =>{
  ...
  getPayoutReportFail(){
    this.reportSerivce.payoutReportFailur()
    .subscribe(
      (res) =>{
        setInterval(()=>{ 
          //  console.log(res);
          this.FailurePayoutTxnCount = res.data[0].FailurePayoutTxnCount;
          this.FailurePayoutTxnAmount = res.data[0].FailurePayoutTxnAmount}, 1000);
  ...
  getPayinReportSuccess(){
    this.reportSerivce.payinReportSuccess()
    .subscribe(
      (res) => {
        // console.log(res);
  ...
  getPayinReportFail(){
    this.reportSerivce.payinReportFailure()
    .subscribe(
      (res) =>{
        // console.log(res);
